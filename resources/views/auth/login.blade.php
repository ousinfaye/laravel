...
@section('content')
    <style>
        ...
        * {
        ...
        .overlay {
            background: #0cc0df;
            background: -webkit-linear-gradient(to right, #0cc0df, #066170);
            background: linear-gradient(to right, #0cc0df, #066170);
        ...
        <div class="form-container sign-up-container">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="social-container">
                    <a href="#" class="social"><i id="fab" class="fab fa-facebook-f"></i></a>
                    <a href="#" class="social"><i id="fab" class="fab fa-google-plus-g"></i></a>
                    <a href="#" class="social"><i id="fab" class="fab fa-linkedin-in"></i></a>
                </div>
