...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Liste des Tâches Archivés</div>
                    <div class="card-body">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel{{ $task->id }}">Supprimer Tâche</h1>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{route('deleteArchivedTask', ['id' => $task->id])}}">
